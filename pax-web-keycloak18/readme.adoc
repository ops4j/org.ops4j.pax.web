...
Password: admin123
Added 'admin' to '/data/servers/keycloak-18.0.2/standalone/configuration/keycloak-add-user.json', restart server to load user
...
13:34:24,007 INFO  [org.jboss.as] (MSC service thread 1-2) WFLYSRV0049: Keycloak 18.0.2 (WildFly Core 15.0.1.Final) starting
...
...
----
karaf@root()> install mvn:org.keycloak/keycloak-osgi-adapter/18.0.2
karaf@root()> install wrap:mvn:org.keycloak/keycloak-tomcat-core-adapter/18.0.2
karaf@root()> install wrap:mvn:org.keycloak/keycloak-tomcat-adapter-spi/18.0.2
karaf@root()> install wrap:mvn:org.keycloak/keycloak-tomcat-adapter/18.0.2
karaf@root()> install mvn:org.keycloak/keycloak-pax-web-tomcat8/18.0.2
----
