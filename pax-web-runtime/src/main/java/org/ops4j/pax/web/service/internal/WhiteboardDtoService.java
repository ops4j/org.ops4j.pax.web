...
//                    PaxWebConstants.DEFAULT_CONTEXT_NAME.equals(entry.getValue().getServletContextName())
//                            || PaxWebConstants.DEFAULT_SHARED_CONTEXT_NAME.equals(entry.getValue().getServletContextName()))
...
//                || contextId == null && Objects.equals(modelId, PaxWebConstants.DEFAULT_CONTEXT_NAME);
//    }
//
//
//    /*
...
//             */
//            name = PaxWebConstants.DEFAULT_CONTEXT_NAME;
//        } else {
//            name = httpContextId;
//        }
