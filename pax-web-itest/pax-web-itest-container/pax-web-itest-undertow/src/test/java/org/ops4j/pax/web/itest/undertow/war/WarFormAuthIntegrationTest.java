...
import org.ops4j.pax.web.itest.container.war.AbstractWarFormAuthIntegrationTest;
...
public class WarFormAuthIntegrationTest extends AbstractWarFormAuthIntegrationTest {
	...
	public Option[] configure() {
		Option[] serverOptions = combine(combine(baseConfigure(), paxWebUndertow()), paxWebJsp());
