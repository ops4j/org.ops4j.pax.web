...
public class WhiteboardRootFilterIntegrationTest extends ITestBase {
	...
	public void testWhiteBoardSlash() throws Exception {
		testClient.testWebPath(retrieveBaseUrl()+"/", "Hello Whiteboard Extender");
	}
	...
	public void testWhiteBoardFiltered() throws Exception {
		...
		testClient.testWebPath(retrieveBaseUrl()+"/", "Filter was there before");
	...
	public void testWhiteBoardNotFiltered() throws Exception {
		...
		testClient.testWebPath(retrieveBaseUrl()+"/whiteboard",
