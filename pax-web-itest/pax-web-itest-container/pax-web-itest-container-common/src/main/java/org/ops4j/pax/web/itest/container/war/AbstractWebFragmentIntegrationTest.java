...
public abstract class AbstractWebFragmentIntegrationTest extends AbstractContainerTestBase {
	...
	public void setUp() throws Exception {
		wab = configureAndWaitForDeploymentUnlessInstalled("war-requiring", () -> {
			installAndStartBundle(sampleURI("war-required"));
			installAndStartBundle(sampleURI("war-requiring"));
		});
	}
