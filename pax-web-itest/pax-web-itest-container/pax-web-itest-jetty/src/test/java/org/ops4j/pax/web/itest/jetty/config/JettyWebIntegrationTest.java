...
public class JettyWebIntegrationTest extends AbstractContainerTestBase {
	...
	public Option[] configure() {
		...
		Option[] authOptions = combine(jspOptions, config);
		return combine(authOptions, paxWebExtenderWar());
	}

	@Before
	public void setUp() throws Exception {
		configureAndWaitForDeploymentUnlessInstalled("war-jetty-web", () -> {
			installAndStartWebBundle("war-jetty-web", "/test");
		});
	}
	...
	public void testStaticContent() throws Exception {
		HttpTestClientFactory.createDefaultTestClient()
				.withResponseAssertion("Response must contain '<h1 class=\"title\">Directory: /static-content/</h1>'",
						resp -> resp.contains("<h1 class=\"title\">Directory: /static-content/</h1>"))
				.doGETandExecuteTest("http://localhost:8282/static-content/");
	}
