    ...
    public void testJsfResourceHandler() throws Exception {
        ...
        new WaitCondition("webresources-extender done") {
            ...
            protected boolean isFulfilled() throws Exception {
                try {
                    String resp = testClient.testWebPath("http://127.0.0.1:8282/osgi-resourcehandler-myfaces/javax.faces.resource/images/iceland.jpg2.xhtml?type=osgi&ln=default&lv=2_0", 200);
                    return resp != null;
