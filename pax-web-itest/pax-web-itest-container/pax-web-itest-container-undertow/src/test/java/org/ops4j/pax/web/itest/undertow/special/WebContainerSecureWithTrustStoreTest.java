...
public class WebContainerSecureWithTrustStoreTest extends AbstractWebContainerSecuredIntegrationTest {
	...
	public static Option[] configure() {
		return OptionUtils.combine(
				...
				systemProperty("org.ops4j.pax.web.ssl.keystore").value(
						WebContainerSecureWithTrustStoreTest.class.getClassLoader().getResource("wss40rev.jks").getFile()),
				...
				systemProperty("org.ops4j.pax.web.crlPath").value(
				                WebContainerCertificateRevocationCheckTest.class.getClassLoader().getResource("wss40CACRL.pem").getFile())*/);
