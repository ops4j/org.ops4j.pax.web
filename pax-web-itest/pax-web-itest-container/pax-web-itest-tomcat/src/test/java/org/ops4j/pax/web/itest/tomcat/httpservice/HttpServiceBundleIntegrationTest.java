...
public class HttpServiceBundleIntegrationTest extends AbstractHttpServiceBundleIntegrationTest {
	...
	public Option[] configure() {
		...
		return combine(
				...
				systemProperty(PaxWebConfig.PID_CFG_LOG_NCSA_LOGFILE).value("access-log"),
				...
				systemProperty(PaxWebConfig.PID_CFG_LOG_NCSA_BUFFERED).value("false")
		);
	}
	...
	public void testNCSALogger() throws Exception {
		...
		final File logFile = new File("target/logs/access-log." + date + ".log");
