...
public class WebSocketIntegrationTest extends AbstractContainerTestBase {
	...
	protected WebSocketContainer getWebSocketContainer() {
		...
		try {
			Bundle tomcatWebSocketClientBundle = bundle("org.ops4j.pax.web.pax-web-tomcat-websocket");
			Thread.currentThread().setContextClassLoader(tomcatWebSocketClientBundle.adapt(BundleWiring.class).getClassLoader());
