...
public class ElIntegrationTest {
	...
	public static Logger log = LoggerFactory.getLogger(ElIntegrationTest.class);
	...
	@Test
	public void elFactory() throws Exception {
		ServiceLoader<ExpressionFactory> loader = ServiceLoader.load(ExpressionFactory.class, this.getClass().getClassLoader());
		for (ExpressionFactory factory : loader) {
			log.info("Found #1 {}", factory);
		}
		loader = ServiceLoader.load(ExpressionFactory.class);
		for (ExpressionFactory factory : loader) {
			log.info("Found #2 {}", factory);
		}
	}
