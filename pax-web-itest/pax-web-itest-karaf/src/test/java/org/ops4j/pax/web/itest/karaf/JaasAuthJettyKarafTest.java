...
public class JaasAuthJettyKarafTest extends AuthBaseKarafTest {
	...
	public Option[] configuration() {
		...
		KarafDistributionConfigurationFileReplacementOption config
				...
				new File("target/test-classes/etc/jetty.xml"));
		...
		return combine(basicOptions, users, config, pid1, pid2, pid3, pid4, pid5);
	}
