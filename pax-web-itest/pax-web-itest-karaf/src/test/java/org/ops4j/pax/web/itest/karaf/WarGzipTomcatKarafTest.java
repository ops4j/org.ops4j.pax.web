 ...
 */
public class WarGzipTomcatKarafTest extends WarBaseKarafTest {

	@Configuration
	public Option[] configuration() {
		Option[] basicOptions = combine(tomcatConfig(), jspConfig());
		KarafDistributionConfigurationFileReplacementOption config
				...
				new File("target/test-classes/etc/gzip-tomcat-server.xml"));
		...
		return combine(basicOptions, config, pid1, pid2, pid3, pid4, pid5, pid6);
	}
