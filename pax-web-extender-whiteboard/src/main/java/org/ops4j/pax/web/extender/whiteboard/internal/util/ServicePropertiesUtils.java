...
public class ServicePropertiesUtils
{
     ...
     * Logger.
     */
    private static final Log LOG = LogFactory.getLog( ServicePropertiesUtils.class );
     ...
     *
     * @return property value; null if property is not set or property value is not a String
     *
    ...
    /**
     * Returns the subset of properties that start with the prefix. The returned dictionary will have as keys the
     * original key without the prefix.
     *
     * @param serviceReference service reference; cannot be null
                                                             ...
                                                             final String prefix )
    {
        ...
        {
            if( key != null && key.startsWith( prefix ) && key.trim().length() > prefix.length() )
            {
