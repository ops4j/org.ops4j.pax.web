...
public class ServletWebElement<T extends Servlet> extends WebElement<T> implements WhiteboardServlet {
	...
	/**
	 * Constructs a new ServletWebElement.
	 ...
	 * @param errorMappings error-page mappings
	 */
	public ServletWebElement(final ServiceReference<T> ref, final ServletMapping servletMapping, List<DefaultErrorPageMapping> errorMappings) {
		super(ref);
