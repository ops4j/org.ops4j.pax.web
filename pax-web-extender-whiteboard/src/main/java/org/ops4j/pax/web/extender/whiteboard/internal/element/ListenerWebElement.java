    ...
    implements WebElement
{
    ...
    public ListenerWebElement( final ListenerMapping listenerMapping )
    {
        ...
        m_listenerMapping = listenerMapping;
    }
                            ...
                            final HttpContext httpContext )
    {
        if( WebContainerUtils.isWebContainer( httpService ) )
        {
            ( (WebContainer) httpService ).unregisterEventListener( m_listenerMapping.getListener() );
        }
    }

    public String getHttpContextId()
    {
        return m_listenerMapping.getHttpContextId();
    }
    ...
    public String toString()
    {
        return new StringBuffer()
            ...
            .append( "{" )
            .append( "mapping=" ).append( m_listenerMapping )
            .append( "}" )
            .toString();
    }
