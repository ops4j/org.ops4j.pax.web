...
public class ManifestIntegrationTest {
	...
	Logger LOG = LoggerFactory.getLogger(ManifestIntegrationTest.class);	
	@Test
    public void testJettyBundleAccess() throws Exception {
        ...
        File file = new File(repodir.getAbsolutePath() + "/org/ops4j/pax/web/pax-web-jetty-bundle/"+getProjectVersion()+"/pax-web-jetty-bundle-"+getProjectVersion()+".jar");
    ...
    public void testJettAccess() throws Exception {
        File repodir = new File(System.getProperty("user.home") + "/.m2/repository");
        Assert.assertTrue("Repository dir exists: " + repodir, repodir.exists());
        File file = new File(repodir.getAbsolutePath() + "/org/ops4j/pax/web/pax-web-jetty/"+getProjectVersion()+"/pax-web-jetty-"+getProjectVersion()+".jar");
        Assert.assertTrue("File exists: " + file, file.exists());
