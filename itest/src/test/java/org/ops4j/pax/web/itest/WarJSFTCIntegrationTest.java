...
public class WarJSFTCIntegrationTest extends ITestBase {
	...
	public void testSlash() throws Exception {
		listBundles();
		testWebPath("http://127.0.0.1:8282/war-jsf-sample/",
	...
	public void testJSF() throws Exception {
		...
		String response = testWebPath("http://127.0.0.1:8282/war-jsf-sample",
				"Please enter your name");
		...
		testPost("http://127.0.0.1:8282/war-jsf-sample/faces/helloWorld.jsp",
				nameValuePairs,
