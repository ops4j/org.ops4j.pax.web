...
public class WarTCIntegrationTest extends ITestBase {
 ...
 Logger LOG = LoggerFactory.getLogger(WarTCIntegrationTest.class);
	...
	public void testWC_example() throws Exception {
		...
		testWebPath("http://127.0.0.1:8282/war/wc/example", "<h1>Hello World</h1>");
	...
	public void testSubJSP() throws Exception {
		...
		testWebPath("http://127.0.0.1:8282/war/wc/subjsp", "<h2>Hello World!</h2>");
