...
public class ClassPathUtil {
    ...
    /**
     * Gets the locations of the bundles in the Class Space. Beware, in Karaf this will return the
     * URL with which the bundle was originally provisioned, i.e. could potentially return wrap:...,
     * mvn:..., etc. and even include URL parameters (i.e. ?Webapp-Context=...).
     *
     * @param bundle
    ...
    private static Set<Bundle> getBundlesInClassSpace(BundleContext context, Bundle bundle,
        ...
        if (!bundleSet.containsAll(bundles)) { // now let's scan transitively
            ...
            for (Bundle importedBundle : bundles) {
                transitiveBundles
                    .addAll(getBundlesInClassSpace(context, importedBundle, bundleSet));
            }
        }
