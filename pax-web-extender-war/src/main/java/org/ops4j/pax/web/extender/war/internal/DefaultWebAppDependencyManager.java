...
public class DefaultWebAppDependencyManager {
	...
	private ConcurrentMap<BundleWebApplication, ReplaceableService<HttpService>> trackers;
//	private ConcurrentHashMap<BundleWebApplication, ServiceRegistration<WebAppDependencyHolder>> services;
...
//		this.services = new ConcurrentHashMap<>();
	...
	public void addWebApp(final BundleWebApplication webApp) {
...
//		}
	...
	public void removeWebApp(BundleWebApplication webApp) {
