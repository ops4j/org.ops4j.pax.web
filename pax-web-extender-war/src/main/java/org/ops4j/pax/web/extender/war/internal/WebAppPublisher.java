...
class WebAppPublisher {
	 ...
	 * In use web apps.
	 */
//	private final Map<BundleWebApplication, ServiceTracker<WebAppDependencyHolder, WebAppDependencyHolder>> webApps;
...
//		webApps = Collections
//				.synchronizedMap(new HashMap<BundleWebApplication, ServiceTracker<WebAppDependencyHolder, WebAppDependencyHolder>>());
	 ...
	 */
	public void publish(final BundleWebApplication webApp) {
...
//		}
	 ...
	 * @throws NullArgumentException if web app is null
	 */
	public void unpublish(final BundleWebApplication webApp) {
//		NullArgumentException.validateNotNull(webApp, "Web app");
...
//		 */
//		private final BundleWebApplication webApp;
//
//		private final WebApplicationEventDispatcher eventDispatcher;
//
...
//		 * @throws NullArgumentException if web app is null
//		 */
//		WebAppDependencyListener(final BundleWebApplication webApp,
