 ...
 */
package org.ops4j.pax.web.service.tomcat.bundle.internal;
...
public class CompositeActivator implements BundleActivator {
	...
	private final BundleActivator tomcatActivator;

	public CompositeActivator() {
		paxWebActivator = new org.ops4j.pax.web.service.internal.Activator();
		tomcatActivator = new org.ops4j.pax.web.service.tomcat.internal.Activator();
	}
