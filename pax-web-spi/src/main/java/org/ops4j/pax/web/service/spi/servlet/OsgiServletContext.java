...
public class OsgiServletContext implements ServletContext {
	...
	public OsgiServletContext(ServletContext container, OsgiContextModel contextModel, Bundle bundle) {
	...
	public RequestDispatcher getRequestDispatcher(String path) {
		...
		//  - servlet2 mapped to /s2/*, associated with ServletContextHelper sch1
	...
	public RequestDispatcher getNamedDispatcher(String name) {
		ServletModel servletModel = contextModel.getServletContextModel().getNameMapping().get(name);
