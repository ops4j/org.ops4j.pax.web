...
public class HttpServiceHandler extends ServletHandler {
	...
	@Override
	public void handle(final String target, final HttpServletRequest request, final HttpServletResponse response, final int dispatchMode) throws IOException, ServletException {
		String trimmedtarget = trimTrailingChars(target,'/');
		handle(trimmedtarget, trimmedtarget, request, response, dispatchMode);
	}

	private void handle(final String requestTarget, final String target, final HttpServletRequest request, final HttpServletResponse response, final int dispatchMode) throws IOException, ServletException {
		String match = target;
