...
public class ConfigurationAdminBackupTest
{
    ...
    private ConfigurationAdminBackup m_underTest;
    ...
    public void setUp()
    {
        ...
        m_underTest = new ConfigurationAdminBackup( m_bundleContext, m_serverManager );
    }
        ...
        throws ConfigurationException
    {
        ...
        m_underTest.frameworkEvent( new FrameworkEvent( FrameworkEvent.STARTED, m_bundle, null ) );
