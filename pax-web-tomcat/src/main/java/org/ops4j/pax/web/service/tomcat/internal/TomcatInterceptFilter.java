...
public abstract class TomcatInterceptFilter implements Filter {
	...
	public void doFilter(ServletRequest servletRequest,
			ServletResponse servletResponse, FilterChain originalChain)
		...
		if (servletRequest instanceof HttpServletRequest
			...
			DelegatingFilterChain filterChain = new DelegatingFilterChain(
					filters);
	...
	protected abstract void copy(InputStream inputStream,
