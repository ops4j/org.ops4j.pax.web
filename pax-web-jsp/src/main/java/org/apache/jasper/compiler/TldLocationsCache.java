...
public class TldLocationsCache {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(TldLocationsCache.class);
	...
	private void tldScanBundlesInClassSpace() throws JasperException,
			IOException {
	...
	private void tldScanStream(String resourcePath, String entryName,
		...
		try {
			...
			TreeNode tld = new ParserUtils().parseXMLDocument(resourcePath,
					stream);
