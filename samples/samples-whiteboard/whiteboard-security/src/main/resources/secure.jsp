...
<body>
<c:if test="${verySecure}">
    <p><b style="color: #A44">Pax Web Security example (very secure area)</b></p>
</c:if>
<c:if test="${not verySecure}">
    <p><b style="color: #44A">Pax Web Security example (secure area)</b></p>
</c:if>
<p>
