    ...
    implements BundleActivator
{
        ...
        throws Exception
    {
        ...
        if( m_httpServiceRef != null )
        {
            ...
            {
                m_httpServiceConfigurer =
                    (HttpServiceConfigurer) bundleContext.getService( m_httpServiceConfigurerRef );
                m_httpService.registerServlet( "/config/set", new HttpConfigurerServlet( m_httpServiceConfigurer ),
                                               new Hashtable(), null
                );
                m_httpService.registerServlet( "/config/stats",
                                               new DisplayConfigurationServlet( m_httpServiceConfigurer ),
                                               new Hashtable(), null
                );
